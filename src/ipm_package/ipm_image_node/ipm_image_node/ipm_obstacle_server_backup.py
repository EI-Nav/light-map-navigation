...
class IPMContourProjection(Node):
    ...
    def publish_scan(self):
        ...
        # 过滤点云
        filtered_points = self.filter_points_by_robot(points)
        ...
        self.get_logger().info(f"Published LaserScan with {len(noisy_points)} points.")
    ...
    def publish_pointcloud(self):
        ...
        self.get_logger().info(f"Published PointCloud2 with {len(noisy_points)} points.")
