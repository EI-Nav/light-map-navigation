...
def get_world_config(world_type):
    world_configs = {
        ...
        WorldType.OSM : {
            ...
            'z': '0.1',
            'yaw': '0.0',
            'world_path': 'osm/large_osm.world'
        },
        WorldType.ROOM : {
            'x': '-6.0',
            'y': '0.0',
            'z': '0.1',
            'yaw': '0.0',
            'world_path': 'room/testroom.world'            
        },
        WorldType.TOSM : {
            'x': '0.0',
            'y': '0.0',
        ...
        WorldType.MOSM : {
            ...
            'z': '0.1',
            'yaw': '-1.76',
            'world_path': 'osm/medium_osm.world'            
        },
    }
...
def generate_launch_description():
    ...
    bringup_TOSM_cmd_group = create_gazebo_launch_group(WorldType.TOSM)
    bringup_ROOM_cmd_group = create_gazebo_launch_group(WorldType.ROOM)
    bringup_MOSM_cmd_group = create_gazebo_launch_group(WorldType.MOSM)
    ...
    ld.add_action(bringup_TOSM_cmd_group)
    ld.add_action(bringup_MOSM_cmd_group)
