...
HM3D_CONFIG_PATH = "/home/bdi/hdj/habitat-lab/habitat-lab/habitat/config/benchmark/nav/objectnav/objectnav_hm3d.yaml"
...
def hm3d_config(path:str=HM3D_CONFIG_PATH,stage:str='val',episodes=200):
    ...
    with read_write(habitat_config):
        ...
        habitat_config.habitat.dataset.scenes_dir = "/home/bdi/hdj/InstructNav/data/scene_datasets"
        habitat_config.habitat.dataset.data_path = "/home/bdi/hdj/InstructNav/data/objectnav_hm3d_v1/{split}/{split}.json.gz"
        habitat_config.habitat.simulator.scene_dataset = "/home/bdi/hdj/InstructNav/data/versioned_data/hm3d-0.2/hm3d/hm3d_annotated_basis.scene_dataset_config.json"
